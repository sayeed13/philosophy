                    ...
                    <div class="s-content__author-about">
                        ...
                        <ul class="s-content__author-social">
                          <?php
                            ...
                            $philosophy_author_youtube = get_field('youtube',"user_".get_the_author_meta('ID'));
                          ?>
                          ...
                          <?php endif; ?> 
                          <?php if($philosophy_author_youtube): ?>
                           <li><a href="<?php echo esc_url($philosophy_author_youtube) ?>">Youtube</a></li>
                          <?php endif; ?> 
                        </ul>
                    </div>
                </div>
