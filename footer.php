    ...
    <section class="s-extra">
        ...
        <div class="row top">
                        ...
                        while ($philosophy_popular_posts->have_posts()){
                            ...
                            <article class="col-block popular__post">
                                ...
                                <section class="popular__meta">
                                        <span class="popular__author"><span><?php _e('By', 'philosophy'); ?></span> <a href="<?php echo esc_url(get_author_posts_url('user_'.get_the_author_meta('ID'))); ?>"> <?php the_author(); ?></a></span>
            ...
            <div class="col-four md-six tab-full about">
                <?php
                if(is_active_sidebar('about_us_footer')){
                    dynamic_sidebar('about_us_footer');
                }
                ?>
